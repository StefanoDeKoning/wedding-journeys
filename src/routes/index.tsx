  ...
  return (
    <SiteShell>
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-24 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-warm border border-border/60">
              <img src={hero} alt="Romantic autumn wedding table" width={1600} height={1200} className="w-full h-auto" />
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((f) => (
            <article
              key={f.t}
              className="group relative rounded-2xl border border-border bg-card p-6 hover:border-primary/40 hover:shadow-soft transition-all"
            >
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="rounded-[2rem] border border-border bg-gradient-soft p-10 md:p-14">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={b.t} className="flex gap-4 items-start bg-card border border-border rounded-2xl p-5">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              {["Wedding website", "RSVP dashboard", "Budget planner", "Timeline editor"].map((s) => (
                <div key={s} className="rounded-xl border border-border bg-card px-4 py-3 text-sm">
